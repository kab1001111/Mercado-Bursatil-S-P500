...
st.sidebar.markdown('## Que es el indice S&P500?')
...
Retorno sobre la inversión (ROI): Este KPI mide el rendimiento financiero de una inversión en términos de la cantidad de dinero que se ganó o perdió en relación con la cantidad invertida.''')
